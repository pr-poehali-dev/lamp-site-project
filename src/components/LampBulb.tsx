...
const LampBulb: React.FC<LampBulbProps> = ({ isOn, toggle }) => {
  return (
    <div className="relative flex items-center justify-center w-[180px] h-[250px]">
      <svg
        width="180"
        height="250"
        viewBox="0 0 180 250"
        className={`absolute transition-all duration-300 ${isOn ? "bulb-on" : "opacity-75"} ${toggle ? "cursor-pointer hover:scale-105" : ""}`}
